...
<div class="section-title">
    <h3>Students list</h3>
        ...
        print '<h6 class= "successMessage">Student Deleted.</h6>';
				...
				print '<table>';
				print '<tr><th>ID</th><th>Student Name</th><th>Gurdian Name</th><th>Contact</th><th>Email</th><th>Address</th><th>Class</th><th>Shift</th><th>Gender</th><th>Blood Group</th><th>Faculty</th><th>Action</th></tr>';
				...
				while($row = mysqli_fetch_assoc($table))
				{
					...
					print '<td>'.htmlentities($row["Faculty"]).'</td>';
